    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('waktu_peminjaman', models.IntegerField(choices=[(1, 'Pagi (09:00 - 12:00)'), (2, 'Siang (12:00 - 16:00)'), (3, 'Sore (16:00 - 19:00)')])),
                ('status', models.CharField(default='Proses', max_length=10)),
                ('tanggal_pakai', models.DateField()),
                ('alasan', models.TextField(default=None, null=True)),
